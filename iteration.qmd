...
This folder can be found at <https://github.com/hadley/r4ds/tree/main/data/gapminder>.
...
That's because R's orientation towards data analysis changes how we iterate: in most cases you can rely on an existing idiom to do something to each column or each group.

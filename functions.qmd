...
To write a function you need to first analyse your repeated code to figure out what parts are constant and what parts vary.
...
For example, this `clamp()` function ensures all values of a vector lie in between a minimum and a maximum:
...
Maybe you need to make the first character uppercase:

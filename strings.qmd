...
The trick is that glue uses a slightly different escaping technique: instead of prefixing with a special character like `\`, you double up the special characters:

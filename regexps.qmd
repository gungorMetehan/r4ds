...
In this book, we'll usually write regular expressions without quotes, like `\.`.
...
You'll find stringi very easy to pick up because it follows many of the same conventions as stringr.
